...
resource "azurerm_application_gateway" "network" {
  ...
  ssl_policy {
    # disabled_protocols   = var.appgw_config.ssl_policy.disabled_protocols
  ...
  waf_configuration {
    enabled          = var.appgw_config.waf_configuration.enabled
    firewall_mode    = var.appgw_config.waf_configuration.firewall_mode
    rule_set_version = var.appgw_config.waf_configuration.rule_set_version
  }
